...
describe("SettingsService", () => {
  ...
  describe("getSetting", () => {
    ...
    it("should load settings if not cached", async () => {
      const mockDbSettings = [{ key: "tax_rate", value: "0.20" }];
  ...
  describe("setSetting", () => {
    it("should update setting in database and cache", async () => {
      ...
      expect((settingsService as any).cachedSettings.companyName).toBe(
        "New Company"
      );
    });
    ...
    it("should handle database errors", async () => {
      ...
      await expect(
        settingsService.setSetting("companyName", "Failed Company")
  ...
  describe("Subscription System", () => {
    ...
    it("should handle change listeners correctly", () => {
      ...
      (settingsService as any).notifyChangeListeners(
        "companyName",
        "Test Change"
      );
  ...
  describe("Serialization", () => {
    ...
    it("should deserialize values correctly", () => {
      ...
      // String values
      expect(service.deserializeValue("companyName", "Test Company")).toBe(
        "Test Company"
      );
